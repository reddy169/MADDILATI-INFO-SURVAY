      ...
      <div class="col-lg-3">
        <div class="bg-white p-4 shadow-sm">      
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li><a class="active" href="bankaccount">Bank Account Info</a></li>
            ...
            <div class="user-dashboard-info-box bg-white p-4 shadow-sm">
              ...
              <div class="section-title-02 mb-2">
                ...
                <div class="form-row">
                  <div class="form-group col-sm-6">
                    <label>Account Holder Name<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Account Holder Name ..." required>
                  </div>
                  <div class="form-group col-sm-6">
                    <label>Account Number<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Enter Account Number ..." required>
                  </div>
                  <div class="form-group col-sm-6">
                    <label>IFSC Code<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Enter IFSC Code ..." required>
                  </div>
                  <div class="form-group col-sm-6">
                    <label>Branch Name<span style="color:red;font-size: 14px;"> *</span></label>
              ...
              <div class="form-row">
                  <div class="form-group col-sm-6">
                    ...
                    <label>Passbook Front Page<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="file"   required>
                  </div>
                  <div class="form-group col-sm-6">
                    
                    <label>Cancelled Check<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="file"   required>
                  </div>
                ...
                <div class="">
                  ...
                  <a class="btn btn-md btn-primary mt-4" href="nomineeinfo" style="float: right;">Next</a>
                </div>
              </form>
            </div>
