  ...
  <nav class="navbar navbar-static-top navbar-expand-lg navbar-light header-sticky">
    <div class="row" style="margin-left: 20px;margin-top: -10px;">
      ...
      <a class="navbar-brand" href="index">
        <img class="img-fluid" src="images1/logo.png" alt="logo" style="margin-left: 60px;">
      </a>
      ...
      <div class="col-lg-3">
        <div class="bg-white p-4 shadow-sm">      
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li><a class="active" href="acadamic">Academic Info</a></li>
         ...
         <div class="row">
          <div class="col-md-12">
            <div class="user-dashboard-info-box bg-white p-4 shadow-sm">
              ...
              <h5>Post-graduation Info</h5>
              <form>
                <div class="form-row">
                  <div class="form-group col-sm-6">
                    <label>Educational Qualification<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Qualification." required>
                  </div>
                  <div class="form-group col-sm-6">
                    <label>Educational Institute<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Inistitute Name ..." required>
                  </div>
                  <div class="form-group col-sm-6">
                    <label>Aggregate<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Aggregate" required>
                  </div>
                  <div class="form-group col-sm-6">
                    <label>Year of Passing<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Enter Mother Name ..." required>
                  </div>

                  <div class="form-group col-sm-6">
                    <div ><p>Upload your document in pdf format</p></div>
                    <label>Academic Document<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="file"   required>
                  </div>

                  <div class="form-group col-sm-6"></div>
                  
                  <h5 style="margin-top: 20px;">Graduation Info</h5>
                  <div class="form-row">
                  <div class="form-group col-sm-6">
                    <label>Educational Qualification<span style="color:red;font-size: 14px;"> *</span></label>
                ...
                <h5 style="margin-top: 20px;">Intermediate Info</h5>
                  <div class="form-row">
                  <div class="form-group col-sm-6">
                    <label>Educational Qualification<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Enter First Name ..." required>
                ...
                <h5 style="margin-top: 20px;">SSC Info</h5>
                  <div class="form-row">
                  <div class="form-group col-sm-6">
                    <label>Educational Qualification<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Enter First Name ..." required>
                  ...
                  <div class="form-group col-sm-6">
                   ...
                   <h5 style="margin-top: 20px;">If any extra course done...</h5>
                  <div class="form-row">
                  <div class="form-group col-sm-6">
                    <label>Educational Qualification<span style="color:red;font-size: 14px;"> *</span></label>
                    <input type="text" class="form-control" placeholder="Enter First Name ..." required>
                ...
                <div class="">
                  ...
                  <a class="btn btn-md btn-primary mt-4" href="bankinfo" style="float: right;">Next</a>
                </div>
