...
<title>Change Password | Maddileti Info</title>
				...
				<div class="graphs">
					...
					<div class="sign-up">
						<div class="sign-in-form-top">
							...
							<p><a href="index"><img src="${pageContext.request.contextPath}/resource/images/logo.png" style="width: 110px;height: 110px;display: block;margin-left: auto;margin-right: auto;" alt="logo" class="logo2"></a></p>
                        ...
                        <div class="sign-u">
                            <div class="sign-up1">
                                <h4 style="font-size: 16px;">Create Password* :</h4>
                            </div>
                            <div class="sign-up2">
                                <form>
