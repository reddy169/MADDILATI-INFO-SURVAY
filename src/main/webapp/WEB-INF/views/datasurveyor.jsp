...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/cdnjs.cloudflare.com/ajax/libs/normalize/8.0.0/normalize.css">
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ['Performance', 'Current Month', 'Last Month'],
          ['First Week', 8000, 23.3],
          ['Second Week', 24000, 4.5],
          ['Third Week', 30000, 14.3],
          ['Fourth Week', 60000, 13.1]
        ...
        var options = {
          ...
          axes: {
            x: {
              distance: {label: 'Surveys Done'}, // Bottom x-axis.
 ...
 <nav class="navbar-vertical navbar">
    <div class="nav-scroller">
        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
            <li class="nav-item">
                <div>
        <a class="navbar-brand" href="datasurveyor">
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
              ...
              <div>
                    ...
                    <h3 class="mb-0 fw-bold text-white" style="text-align: center;font-size: 40px;">Data Surveyor Dashboard</h3>
              ...
              <div>
                <div class="d-flex justify-content-between align-items-center">
                  <div class="mb-2 mb-lg-0">
                    <h3 class="mb-0 fw-bold text-white">Activities</h3>
                  </div>
                  <div>
                    <a href="surveyforms" class="btn btn-white">Survey</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class=" row ">
    <div class="">
  <a href="agriculture"><button class="btn btn-primary  col-lg-2 ms-4" style="border:1px solid violet" >Agriculture</button></a>
  ...
  <a href="health"><button class="btn btn-primary col-lg-2 ms-4" style="border:1px solid violet" >Health</button></a>
