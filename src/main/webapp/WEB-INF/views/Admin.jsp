...
.tabcontent {
  ...
  <body>
    <div id="db-wrapper">
      <!-- navbar vertical -->
       <!-- Sidebar -->
 <nav class="navbar-vertical navbar" style="background-color: #6B0F6B;">
             ...
             <!-- Nav item -->
              ...
              <li class="nav-item">
                  <a class="nav-link has-arrow  collapsed " href="#!" data-bs-toggle="collapse" data-bs-target="#navAuthentication" aria-expanded="false" aria-controls="navAuthentication">
                    <i class="nav-icon icon-xs me-2 " data-feather="users">
                </i>  Employees
                </a>
                ...
                <div id="navAuthentication" class="collapse " data-bs-parent="#sideNavbar">
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="zonalhead">
                                Zonal Head
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link has-arrow"  href="regionalhead" >
                                Regional Head
                              </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="datasurveyor">
                                Data Surveyor
                            </a>
                        </li>
                ...
                <div id="navPages" class="collapse " data-bs-parent="#sideNavbar">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="pages/health">
                               Health
                </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="pages/graphs.html">
      ...
      <li class="dropdown ms-2">
        ...
        <div class="dropdown-menu dropdown-menu-end"
          ...
          <ul class="list-unstyled">
            ...
            <li>
              <a class="dropdown-item" href="pages/signout.html">
                <i class="me-2 icon-xxs dropdown-item-icon"
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
              ...
              <div>
                    ...
                    <h3 class="mb-0 fw-bold text-white" style="text-align: center;font-size: 40px;">Admin Dashboard</h3>
              ...
              <div>
                <div class="d-flex justify-content-between align-items-center">
                  <div class="mb-2 mb-lg-0">
                    <h3 class="mb-0 fw-bold text-white">Survey Details</h3>
                  </div>
                  <div>
                    <a href="pages/livesurvey.html" class="btn btn-white">Live Survey</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card rounded-3">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center
                    mb-3">
                    <div class="">
                      <h4 class="mb-0" style="font-weight: bold;font-size: 22px;">Agriculture</h4>
                    </div>
                  ...
                  <div>
                    ...
                    <a href="pages/agriculture.html"><button class="btn btn-outline-primary" style="border:1px solid violet" >Details</button></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card rounded-3">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center
                    mb-3">
                    <div>
                      <h4 class="mb-0" style="font-weight: bold;font-size: 22px;">Business</h4>
                    </div>
                  ...
                  <div>
                    <h1 class="fw-bold">132</h1>
                      <a href="pages/business.html"><button class="btn btn-outline-primary" style="border:1px solid violet" >Details</button></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card rounded-3">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center
                    mb-3">
                    <div>
                      <h4 class="mb-0" style="font-weight: bold;font-size: 22px;">Finance</h4>
                    </div>
                  ...
                  <div>
                    ...
                    <a href="pages/finance.html"><button class="btn btn-outline-primary" style="border:1px solid violet" >Details</button></a>
                  </div>
                </div>
              </div>
              ...
              <div class="card rounded-3">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center
                    mb-3">
                    <div>
                      <h4 class="mb-0" style="font-weight: bold;font-size: 22px;">Health</h4>
                    </div>
                  ...
                  <div>
                    ...
                    <a href="pages/health.html"><button class="btn btn-outline-primary" style="border:1px solid violet" >Details</button></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card rounded-3">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center
                    mb-3">
                    <div>
                      <h4 class="mb-0" style="font-weight: bold;font-size: 22px;">Education</h4>
                    </div>
                    
                  </div>
                  <!-- project number -->
                  <div>
                    <h1 class="fw-bold">66</h1>
                    <a href="pages/education.html"><button class="btn btn-outline-primary" style="border:1px solid violet" >Details</button></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
              ...
              <div>
                <div class="d-flex justify-content-between align-items-center">
                  <div class="mb-2 mb-lg-0">
                    <h3 class="mb-0 fw-bold " style="color:purple;">Employee Details</h3>
                  </div>
...
<div class=" row tab ">
  ...
  <button class="col-sm-3  tablinks" style="border:1px solid violet" onclick="openCity(event, 'London')">Admin</button>
  <button class="col-sm-3  tablinks" style="border:1px solid violet" onclick="openCity(event, 'bank1')">Zonal Heads</button>
  <button class="col-sm-3  tablinks" style="border:1px solid violet" onclick="openCity(event, 'Tokyo')">Regional Heads</button>
  <button class="col-sm-3  tablinks" style="border:1px solid violet" onclick="openCity(event, 'Paris')">Data Surveyors</button>
  ...
  <form class="form-inline" style="display: flex;
    ...
    <button type="submit" style="margin-top: 0px;" class="btn btn-primary mb-0">View</button>
