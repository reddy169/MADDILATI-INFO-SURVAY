    ...
    var placements = [
        {
            ...
            body: '<p><a class="freelance" href="#">Freelance</a></p>' +
        ...
        },
        {
            ...
            body: '<p><a class="part-time" href="#">Part-time</a></p>' +
                '<div class="mt-2 job-grid-map-price"><span class="mr-2"><i class="fas fa-filter pr-1"></i>Accountancy </span> <span class="ml-auto"> <i class="fas fa-map-marker-alt pr-1"> </i> Needham, MA </span></div>',
        ...
        },
        {
            ...
            body: '<p><a class="temporary" href="#">Temporary</a></p>' +
                '<div class="mt-2 job-grid-map-price"><span class="mr-2"><i class="fas fa-filter pr-1"></i>Accountancy </span> <span class="ml-auto"> <i class="fas fa-map-marker-alt pr-1"> </i> Needham, MA </span></div>',
        ...
        },
        {
            ...
            body: '<p><a class="full-time" href="#">Full time</a></p>' +
                '<div class="mt-2 job-grid-map-price"><span class="mr-2"><i class="fas fa-filter pr-1"></i>Accountancy </span> <span class="ml-auto"> <i class="fas fa-map-marker-alt pr-1"> </i> Needham, MA </span></div>',
